...
$capabilities = array(
    ...
    'mod/quizsecurity:manageoverrides' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'editingteacher' => CAP_ALLOW,
    ...
    // Preview the quiz.
    'mod/quizsecurity:preview' => array(
    ...
    // Regrade quizzes.
    'mod/quizsecurity:regrade' => array(
        'riskbitmask' => RISK_SPAM,
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
        ...
        'clonepermissionsfrom' =>  'mod/quizsecurity:grade'
    ),

    // View the quiz reports.
    'mod/quizsecurity:viewreports' => array(
    ...
    'mod/quizsecurity:deleteattempts' => array(
    ...
    'mod/quizsecurity:ignoretimelimits' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array()
    ),
    ...
    'mod/quizsecurity:emailconfirmsubmission' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array()
    ),
    ...
    'mod/quizsecurity:emailnotifysubmission' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array()
    ),
    ...
    'mod/quizsecurity:emailwarnoverdue' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array()
    ),
